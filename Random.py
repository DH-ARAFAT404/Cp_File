...
def fuck():
    ...
    print(' [+] OK Ids saved in ARAFAT/OK.txt')
    print(' [+] CP Ids saved in ARAFAT/CP.txt')
    print(mumitx)
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[ARAFAT]├Ч[%s/%s]├Ч[OK-%s]├Ч[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[ARAFAT-CP] {cid}|{ps}")
